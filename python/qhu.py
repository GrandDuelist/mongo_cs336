...
if __name__ == '__main__':
    ...
    train = pd.read_csv(os.path.join(os.path.dirname(__file__), '..', 'unlabeledTrainData.tsv'), header=0, \
                    delimiter="\t", quoting=3)
   ...
   # for i in xrange( 0, len(train["review"])):
    ...
    #output.to_json(os.path.join(os.path.dirname(__file__), 'data', 'train_words.json') )
    #print "Wrote results to Bag_of_Words_model.csv"
    #print "Wrote cleaned data to .json file"